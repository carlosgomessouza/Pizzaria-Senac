...
<jsp:include page="action-bar.jsp" />
    ...
    <div class="containerr">
      ...
      <div class="formulario">
        ...
        <div class="form-floating mb-3 row">
            <input type="text" class="form-control" name="value" id="floatingInput" placeholder="name@example.com">
            <label for="floatingInput">Preço</label>
        </div>
        <div class="form-floating mb-3 row">
            <select type="tel" class="form-control" name="productType" id="floatingInput" placeholder="name@example.com">
